...
if(isset($_POST["register"])){
      ...
      $sql = "Select * from `admin` where lastname ='$lastname' and adminId='$adminId'";
    ...
    <section>
        ...
        <div class="form-box">
            ...
            <div class="input">
                ...
                <input type="password" name="adminId" required>
            ...
            <div class="registration">
                <p>
                <p>Not Yet an Admin? <a href="signup.php">Contact Shedless</a></p>
